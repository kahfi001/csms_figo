...
Route::get('/vendor-data', [VendorController::class, 'index'])->middleware('auth', 'verified')->name('vendor');
Route::get('/vendor-data/{id}', [VendorController::class, 'show'])->middleware('auth', 'verified')->name('vendor.detail');
